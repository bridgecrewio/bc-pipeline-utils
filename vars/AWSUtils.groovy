class AWSUtils {
    ...
    def nukeAccount(awsAccount) {
        ...
        def accountMapping = this.script.readJSON file: "account_mapping_profile.json"
        ...
        this.script.sh """                        
          ...
          """
        this.script.withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: awsAccount, accessKeyVariable: 'AWS_ACCESS_KEY_ID', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]) {
            this.script.script {
